...
fun Home(navi: Navigator) {
    ...
    BackgroundBox(contentAlignment = Alignment.Center) {
        ColumnFactory {
            ...
            ButtonFactory { TextFactory("App1")() } / {
                onClick = { navi.navigate("app1/123456") }
            } *= {
                space(16.dp)
            }
            ButtonFactory { TextFactory("App1 But With a Name")() } / {
                onClick = { navi.navigate("app1/123456/Om Gupta") }
            } *= {
                space(16.dp)
            }
            ButtonFactory { TextFactory("Hidden Page")() } /= {
                onClick = { navi.navigate("hidden/boo!") }
            }
            ButtonFactory { TextFactory("Theme Selector")() } /= {
                onClick = { navi.navigate("themes") }
            }
        } /= {
